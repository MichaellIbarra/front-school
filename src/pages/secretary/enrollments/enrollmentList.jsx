...
const EnrollmentList = () => {
  ...
  /**
   * Exporta la lista de matrículas actual a Excel
   */
  const handleExportEnrollments = async () => {
    try {
      // Importar dinámicamente la utilidad de exportación
      const ExportUtils = await import('../../../utils/enrollments/exportUtils');
      ...
      ExportUtils.exportEnrollmentsToExcel(dataToExport);
