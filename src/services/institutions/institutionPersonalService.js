...
class InstitutionPersonalService {
  constructor() {
    this.baseURL = `${process.env.REACT_APP_DOMAIN}/api/v1/institutions/personal`;
  }
  ...
  /**
   * Obtiene la institución del personal autenticado
   * GET /api/v1/institutions/personal
   */
  async getPersonalInstitution() {
    try {
      return await this.executeWithRetry(async () => {
        console.log('📤 Obteniendo institución del personal:', this.baseURL);
      ...
      console.error('Error al obtener institución del personal:', error);
      return {
        success: false,
...
export default new InstitutionPersonalService();